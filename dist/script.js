...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var modulePageSlider = new _modules_slider_mainSlider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  modulePageSlider.render();
  var showupSlider = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  moduleSlider.init();
  var feedSlider = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      link.click(); // вызов события программно 
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "checkMailInputs",
    value: function checkMailInputs(selector) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides.forEach(function (slide) {
        // убрали display: block у всех элементов слайдера
        slide.style.display = 'none';
      });
      this.slides[this.slideIndex - 1].style.display = 'block'; // назначили первому
    }
  }, {
    key: "plusSlides",
